...
harpy::system::cxx_save_sys::cxx_save_sys()
{
    /*hashiers.resize(std::thread::hardware_concurrency(), {{}, true});*/
}

void harpy::system::cxx_save_sys::save(std::string filename, blob file)
{
...
harpy::system::blob harpy::system::cxx_save_sys::load(std::string hash)
{
...
void harpy::system::cxx_save_sys::choose_base_filepath()
{
...
void harpy::system::cxx_save_sys::choose_base_filepath(std::string filepath)
{
